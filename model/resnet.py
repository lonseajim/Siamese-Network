...
# CNN parameters in paper 'Rapid identification of pathogenic bacteria using Raman spectroscopy and deep learning'
# layers = 6
# hidden_size = 100
# block_size = 2
# hidden_sizes = [100] * layers
# num_blocks = [2] * layers
# input_dim = 1000
# in_channels = 64
# n_classes = 30
class ResNet(nn.Module):
    def __init__(self, hidden_sizes, num_blocks, input_dim=1000, in_channels=64, n_classes=30):
